                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      focusedBorder: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(28.0),
                        borderSide: const BorderSide(color: Color(0xFF8F4C38), width: 1.5),
                      ),
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Padding(
                          ...
                          child: ChoiceChip(
                            ...
                            selectedColor: const Color(0xFF8F4C38), // PrimaryGreen
            ...
            Expanded(
              child: displayedWisata.isEmpty
                  ...
                  : ListView.builder(
                      ...
                      itemCount: displayedWisata.length + 2, // 1 for header, 1 for bottom FAB spacing
                      itemBuilder: (context, index) {
                        if (index == 0) {
                          return Padding(
                        ...
                        if (index == displayedWisata.length + 1) {
                          return const SizedBox(height: 72); // bottom spacer for FAB
                        }
                                  ...
                                  children: [
                                    ...
                                    Positioned(
                                      ...
                                      child: Container(
                                        ...
                                        decoration: BoxDecoration(
                                          color: const Color(0xFF8F4C38).withOpacity(0.9),
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        children: [
                                          Icon(
                                            Icons.location_on,
                                            color: const Color(0xFF201A19).withOpacity(0.6),
                                            size: 15,
                                          ),
                                          const SizedBox(width: 4),
                                          Expanded(
                                      ...
                                      Text(
                                        ...
                                        style: TextStyle(
                                          fontSize: 12,
                                          color: const Color(0xFF201A19).withOpacity(0.65),
                                        ),
                                        maxLines: 2,
                                        overflow: TextOverflow.ellipsis,
                                      ),
